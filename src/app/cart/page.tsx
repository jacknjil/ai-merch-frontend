        ...
        >
                ...
                >
                  <div>
                    {item.mockupImageUrl ? (
                      <img
                        ...
                        alt={
                          item.assetTitle ?? item.productName ?? "Cart item"
                        }
                        onError={(e) =>
                          console.error(
                  ...
                  <div>
                    ...
                    >
                      Design:{" "}
                      <strong>
                        {item.assetTitle ?? "(no design title)"}
                      </strong>
                    </p>
          ...
          >
            ...
            <button
              ...
              onClick={() => {
                console.log(
                  "[CART] TODO: wire this button to Stripe checkout."
                );
                alert("Checkout wiring is TODO – Stripe integration goes here.");
              }}
            >
              Proceed to checkout
            </button>
